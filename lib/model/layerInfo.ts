...
export const LAYER_CONFIG: LayerMeta[] = [
  {
    ...
    description:
      "64 filters scan the image looking for basic features like edges, corners, and curves.",
    visualizable: true,
    sectionIndex: 2,
  },
  {
  ...
  },
  {
    ...
    description:
      "128 filters combine basic features into more complex patterns like loops and intersections.",
    visualizable: true,
    sectionIndex: 5,
  },
  {
  ...
  },
  {
    ...
    outputShape: [14, 14, 256],
    description:
      "256 filters detect high-level features like character parts and structural patterns.",
    visualizable: true,
    sectionIndex: 5,
  },
  {
  ...
  },
  {
    ...
    outputShape: [12544],
    description:
      "Reshapes the 7x7x256 volume into a single vector of 12,544 values.",
    visualizable: false,
    sectionIndex: 6,
  },
  {
    ...
    outputShape: [512],
    description:
      "512 neurons combine all spatial features to form a high-level representation of the character.",
    visualizable: true,
    sectionIndex: 6,
  },
  {
  ...
  },
  {
    ...
    outputShape: [146],
    description:
      "Converts raw scores into probabilities across all 146 character classes.",
    visualizable: true,
    sectionIndex: 7,
  },
];
